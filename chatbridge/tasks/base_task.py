...
from chatbridge.common.dist_utils import get_rank, get_world_size, is_main_process, is_dist_avail_and_initialized
...
class BaseTask:
    ...
    def build_datasets(self, cfg):
        ...
        self.gt_file = cfg.run_cfg.get("gt_file", None)
