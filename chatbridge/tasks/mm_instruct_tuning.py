...
import torch
from chatbridge.tasks.valor_train_utils import create_task_dataloaders
@registry.register_task("tri_instruct")
class TriInsructTask(BaseTask):
    def __init__(self):
        super().__init__()
    ...
    def build_dataloader(self, cfg):
        ...
        prompt_path = getattr(cfg.run_cfg, 'prompt_path')
        loader = create_task_dataloaders(valor_data_opts=valor_data_opts_path, prompt_path=prompt_path)
        self.loss_names = getattr(cfg.run_cfg, 'losses', ['lm'])
        # for ds in loader:
        #     import pdb
        #     pdb.set_trace()
        #     print(ds)
